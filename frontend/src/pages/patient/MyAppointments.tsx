    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
            ...
            <div className="p-4 border-b border-gray-100 dark:border-gray-700 flex flex-wrap items-center gap-3">
                <span className="text-sm font-bold text-gray-600 dark:text-gray-400">Sort by:</span>
            ...
            <div className="divide-y divide-gray-100 dark:divide-gray-700">
                {loading ? (
                    ...
                    <div className="p-12 text-center text-gray-500">
                        ...
                        <p>কোন অ্যাপয়েন্টমেন্ট পাওয়া যায়নি।</p>
                    </div>
                ) : (
                    sortedAppointments.map((apt) => (
                        <div key={apt.appointment_id} className="p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            <div className="flex gap-4">
                                <div className="w-14 h-14 rounded-full bg-gray-100 dark:bg-gray-700 overflow-hidden shrink-0">
                                    {apt.doctor_image ? (
                                ...
                                <div>
                                    <h4 className="font-bold text-gray-800 dark:text-white text-lg">{apt.doctor_name || 'Unspecified Doctor'}</h4>
