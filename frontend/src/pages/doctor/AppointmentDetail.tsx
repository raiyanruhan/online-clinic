                        ...
                        <div className="space-y-6">
                            <div className="bg-gray-50 dark:bg-gray-700/30 p-5 rounded-2xl space-y-4">
                                ...
                                {(status === 'ready' || status === 'upcoming') && meetingLink && (
                                    <div>
                                        <label className="block text-sm font-medium mb-1.5 text-gray-600 dark:text-gray-400">Meeting Link</label>
                                        <a
                                            href={meetingLink}
                                            target="_blank"
                                            rel="noreferrer"
                                            className="w-full p-3 bg-green-600 hover:bg-green-700 text-white font-bold rounded-lg flex items-center justify-center gap-2 transition-colors shadow-md shadow-green-600/20"
                                        >
                                ...
                                {(!meetingLink || (status !== 'ready' && status !== 'upcoming')) && (
                                    <div className="p-3 bg-gray-100 dark:bg-gray-700 rounded-lg text-sm text-gray-600 dark:text-gray-400 text-center">
